...
const MenuMd = () => {
  ...
  return (
    <>
      <div className="md:hidden flex justify-around items-center h-12 w-full text-app_lc_text ">
            <Logotipo /> Giovany Alejandro Alfaro Lopez
            <Theme />
        <MenuOutlined onClick={()=>onToggle(true)} />
          </div> 
      ...
      >
        <div className="h-full w-full flex flex-col items-center gap-4  ">
          <div className="flex justify-around items-center h-12 background_bg w-full ">
            <Logotipo /> Giovany Alejandro Alfaro Lopez
            <Theme />
