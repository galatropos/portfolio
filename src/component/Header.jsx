...
const Header = () => {
  ...
  return (
    <div className='flex flex-row w-full'>
          <a className='  p-2 text-center w-full' aria-label="Chat on WhatsApp" target='_blank' 
        ...
        <div onClick={onDownload} className=' w-full p-2 text-center'>{dataHeader[getLanguage][1]} <CloudDownloadOutlined /></div>
  </div>
  )
}
